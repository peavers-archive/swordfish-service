...
public class RestoreQueryGatewayRestController {
    ...
    @Autowired
    public RestoreQueryGatewayRestController(RestTemplate restTemplate, AuthenticationService authenticationService) {
    ...
    public ResponseEntity<String> listAllDeployments(@PathVariable String projectId, @PathVariable String environmentId) {
    ...
    public ResponseEntity<String> viewDeployments(@PathVariable String projectId, @PathVariable String environmentId, @PathVariable String deploymentId) {
        ParameterizedTypeReference<String> reference = new ParameterizedTypeReference<String>() {
        };

        return restTemplate.exchange(SERVICE + "/deployments/{projectId}/{environmentId}/{deploymentId}",
                HttpMethod.GET,
                null,
                reference,
                projectId,
    ...
    @GetMapping("/stacks")
    public ResponseEntity<String> listAllStacks(@RequestHeader("Authorization") String token) {
        ParameterizedTypeReference<String> reference = new ParameterizedTypeReference<String>() {
        };

        return restTemplate.exchange(SERVICE + "/stacks/", HttpMethod.GET, authenticationService.addAuthenticationHeader(), reference);
    }
    ...
    public ResponseEntity<String> viewStacks(@PathVariable String projectId) {
        ...
        return restTemplate.exchange(SERVICE + "/stacks/{projectId}",
                HttpMethod.GET,
                null,
                reference,
                projectId
    ...
    public ResponseEntity<String> listAllSnapshots(@PathVariable String projectId) {
        ...
        return restTemplate.exchange(SERVICE + "/snapshots/{projectId}",
                HttpMethod.GET,
                null,
                reference,
                projectId
    ...
    public ResponseEntity<String> viewSnapshots(@PathVariable String projectId, @PathVariable String snapshotId) {
        ParameterizedTypeReference<String> reference = new ParameterizedTypeReference<String>() {
        };
    ...
    public ResponseEntity<String> transferSnapshots(@PathVariable String projectId, @PathVariable String transferId) {
        ParameterizedTypeReference<String> reference = new ParameterizedTypeReference<String>() {
        };

        return restTemplate.exchange(SERVICE + "/snapshots/transfer/{projectId}/{transferId}",
                HttpMethod.GET,
                null,
                reference,
                projectId,
    ...
    public ResponseEntity<String> viewFetch(@PathVariable("projectId") String projectId, @PathVariable("fetchId") String fetchId) {
        ParameterizedTypeReference<String> reference = new ParameterizedTypeReference<String>() {
        };
