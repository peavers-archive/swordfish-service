...
public class QueueListener {
    ...
    @Autowired
    public QueueListener(SilverstripeService silverstripeService, JsonTransformService jsonTransformService, QueueMessageService queueMessageService) {
    ...
    public void instanceCommandHandler(String payload) {
        ...
        while (!snapshot.isDone()) {
            try {
                ...
                queueMessageService.send("SnapshotRestoreQueue-" + stackEvent.getInstanceId(), link);
