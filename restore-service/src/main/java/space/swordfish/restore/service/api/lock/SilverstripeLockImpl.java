...
public class SilverstripeLockImpl implements SilverstripeLock {
    ...
    public ResponseEntity<JsonNode> lock(String projectId, String environmentId) {
        return restTemplate.exchange(HOST + "/{projectId}/environment/{environmentId}/lock", HttpMethod.POST, null, JsonNode.class, projectId, environmentId);
    }

    @Override
    public ResponseEntity<JsonNode> unlock(String projectId, String environmentId) {
        return restTemplate.exchange(HOST + "/{projectId}/environment/{environmentId}/lock", HttpMethod.DELETE, null, JsonNode.class, projectId, environmentId);
    }
}
