...
public class SnapshotController {
    ...
    public JsonNode view(@PathVariable String projectId, @PathVariable String snapshotId) {
    ...
    public JsonNode create(@RequestBody StackEvent stackEvent) {
        return silverstripeSnapshot.create(stackEvent.getProjectId(), stackEvent).getBody();
    }

    @DeleteMapping("/snapshots/delete/{projectId}/{snapshotId}")
    public JsonNode delete(@PathVariable String projectId, @PathVariable String snapshotId) {
        return silverstripeSnapshot.delete(projectId, snapshotId).getBody();
    }

    @GetMapping("/snapshots/transfer/{projectId}/{transferId}")
    public JsonNode transfer(@PathVariable String projectId, @PathVariable String transferId) {
