...
@Slf4j
@Component
public class SyncStacksFromSilverstripeTask {
    ...
    @Autowired
    public SyncStacksFromSilverstripeTask(ThreadPoolTaskScheduler taskScheduler, CronTrigger cronTrigger, StackRepository stackRepository, SilverstripeService silverstripeService) {
