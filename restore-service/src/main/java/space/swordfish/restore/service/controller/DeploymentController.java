...
public class DeploymentController {
	...
	public JsonNode create(@PathVariable String projectId,
			@PathVariable String environmentId,
			@RequestBody DeploymentEvent deploymentEvent) {
		return silverstripeDeployment.create(projectId, environmentId, deploymentEvent)
				.getBody();
	}
	...
	public JsonNode view(@PathVariable String projectId,
		...
		return silverstripeDeployment.view(projectId, environmentId, deploymentId)
				.getBody();
	}
	...
	public JsonNode delete(@PathVariable String projectId,
			@PathVariable String environmentId, @PathVariable String deploymentId) {
		return silverstripeDeployment.delete(projectId, environmentId, deploymentId)
				.getBody();
	}
}