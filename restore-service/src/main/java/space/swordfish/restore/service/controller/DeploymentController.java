...
public class DeploymentController {
    ...
    public JsonNode create(@PathVariable String projectId, @PathVariable String environmentId, @RequestBody DeploymentEvent deploymentEvent) {
    ...
    public JsonNode view(@PathVariable String projectId, @PathVariable String environmentId, @PathVariable String deploymentId) {
    ...
    public JsonNode delete(@PathVariable String projectId, @PathVariable String environmentId, @PathVariable String deploymentId) {
