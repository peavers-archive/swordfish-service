...
public class SilverstripeSnapshotImpl implements SilverstripeSnapshot {
    ...
    public ResponseEntity<JsonNode> listAll(String projectId) {
        return restTemplate.exchange(HOST + "/{projectId}/snapshots", HttpMethod.GET, null, JsonNode.class, projectId);
    }

    @Override
    public ResponseEntity<JsonNode> view(String projectId, String snapshotId) {
        return restTemplate.exchange(HOST + "/{projectId}/snapshots/{snapshotId}", HttpMethod.GET, null, JsonNode.class, projectId, snapshotId);
    }

    @Override
    public ResponseEntity<JsonNode> create(String projectId, StackEvent stackEvent) {
        return restTemplate.exchange(HOST + "/{projectId}/snapshots", HttpMethod.POST, new HttpEntity<>(stackEvent), JsonNode.class, stackEvent.getProjectId());
    }

    @Override
    public ResponseEntity<JsonNode> delete(String projectId, String snapshotId) {
        return restTemplate.exchange(HOST + "/{projectId}/snapshots/{snapshotId}", HttpMethod.DELETE, null, JsonNode.class, projectId, snapshotId);
    }

    @Override
    public ResponseEntity<JsonNode> transfer(String projectId, String transferId) {
        return restTemplate.exchange(HOST + "/{projectId}/snapshots/transfer/{transferId}", HttpMethod.GET, null, JsonNode.class, projectId, transferId);
    }
}
