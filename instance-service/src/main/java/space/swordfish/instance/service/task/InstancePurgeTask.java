...
public class InstancePurgeTask {
    ...
    @Autowired
    public InstancePurgeTask(@Qualifier("threadPoolTaskScheduler") ThreadPoolTaskScheduler taskScheduler, InstanceRepository instanceRepository) {
    ...
    /**
     * Thread for removing terminated instances from storage when the cron-trigger stipulates
     */
    class RunnableTask implements Runnable {
        ...
        private void removeTerminated() {
            Iterable<Instance> instances = instanceRepository.findAllByState("terminated");
