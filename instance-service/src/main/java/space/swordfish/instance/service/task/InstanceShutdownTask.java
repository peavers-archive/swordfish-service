...
public class InstanceShutdownTask {
    ...
    @Autowired
    public InstanceShutdownTask(@Qualifier("threadPoolTaskScheduler") ThreadPoolTaskScheduler taskScheduler, CronTrigger cronTrigger, InstanceRepository instanceRepository, InstanceEC2Service instanceEC2Service) {
    ...
    class RunnableTask implements Runnable {
        ...
        @Override
        public void run() {
            Iterable<Instance> instances = instanceRepository.findAllByStateAndProduction("running", false);
