...
public class Auth0ServiceImpl implements Auth0Service {
    ...
    /**
     * Private helper method to get the User object from auth0. This shouldn't be exposed but rather write
     * helper methods that make use of it.
     *
     * @param userId String valid user ID.
     * @return User
     */
    ...
    /**
     * Valid user data should be passed in, only containing information that you want to update. Works like a dirty
     * PATCH method, this is how the auth0 SDK is written. Not ideal. Again don't expose this directly
     * but rather use as a wrapper.
     *
     * @param userId String valid user ID.
    ...
    private String getManagementToken() {
        ...
        try {
            ...
            return mapper.readValue(response.getBody(), TokenResponse.class).getAccessToken();
    ...
    /**
     * The actually auth0 entry point into the management API. Will create it's own token as required.
     *
