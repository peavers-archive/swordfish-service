...
public class InstanceController {
    ...
    @Autowired
    public InstanceController(InstanceRepository instanceRepository, JsonTransformService jsonTransformService, AmazonSQSAsync amazonSqs, Auth0Service auth0Service, AuthenticationService authenticationService) {
    ...
    public String findAllByUserId() {
        Iterable<Instance> instances = instanceRepository.findAllByUserId(auth0Service.getUserId(authenticationService.getCurrentToken()));
